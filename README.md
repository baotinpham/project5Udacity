...
* `UpdateFeed` - should update a FEED item created by a current user. A shape of data send by a client application to this function can be found in the `UpdateFeedRequest.ts` file
